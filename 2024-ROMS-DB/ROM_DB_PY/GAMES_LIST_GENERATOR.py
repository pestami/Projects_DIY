...
if __name__ == '__main__':
 ##############################################################################
    ...
    if len(sys.argv)>1:
        ...
        #"1 1 PATHS 2 GENERATE_GAMES_LIST
        sFLAGS='0100 X'.replace(" ", "")
    ...
    if len(sys.argv)>2:
         ...
         sFLAGS='0000 0000 0000 0000 0000 0000 0001X'.replace(" ", "")
...
#    sROOT= "/".join(sCurrentDir.split("/")[:-1])
    ...
    sPathFile_NEW_XML=sROOT_DB + '/gameslists/'
    
    CAX_ROM=cax_xml_rom(sROOT_GAMES)



    if FLAGS["GENERATE_GAMES_LIST"]==1:
        print ("\n##########################################################")
        print ("2. BEGIN Generate GAMES LISTS =====")
...
#             print('Generating XML games list for:' +console + " " + str(value))
        ...
        for key in FLAGSConsole:
             ...
             if value==1:
                print('Generating XML games:' +console)
                newpath=sPathFile_NEW_XML+ '/' + console
                sFileNameXML='gamelist.xml'
                
                if not os.path.exists(newpath):
                    os.makedirs(newpath)                   
                      
                CAX_ROM.make_xml(sPathFileDB,sPathFile_NEW_XML,console,sFileNameXML) 
